...
import com.app.cinema.MobileXXI.detailMovie.MovieDetailActivity;
import com.app.cinema.MobileXXI.detailMovie.MovieDetailFragment;
...
public class Dashboard extends AppCompatActivity implements MovieAdapter.OnItemClickListener, LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public void send_details(Movie movie, int position) {
        if (tabletView) {
            ...
            Intent intent = new Intent(this, MovieDetailActivity.class); // Swap to DetailActivity
