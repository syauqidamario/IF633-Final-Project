package com.app.cinema.MobileXXI.database;
...
public class MovieContract {
    public static final String CONTENT_AUTHORITY = "com.app.cinema.MobileXXI";
    ...
    public static final class MovieEntry implements BaseColumns {
        ...
        public static final String[] MOVIE_COLUMNS = {COLUMN_MOVIE_ID, COLUMN_MOVIE_VOTE_AVERAGE, COLUMN_MOVIE_TITLE,
                COLUMN_MOVIE_BACKDROP_PATH, COLUMN_MOVIE_OVERVIEW, COLUMN_MOVIE_RELEASE_DATE, COLUMN_MOVIE_POSTER_PATH
        };
